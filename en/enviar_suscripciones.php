...
// Contact Subject
$subject = "Email enviado desde en.venecargoxpress.com";

// Contact Message
$message .= 'Nombre Completo: ' . "Nuevo Suscriptor" . "\n";
$message .= 'Email: ' . $_REQUEST['email'] . "\n";
$message .= 'Asunto: ' . "Nuevo Suscriptor en.venecargoxpress.com" . "\n";
...
echo'<script> window.location="http://en.venecargoxpress.com/#suscripciones"</script>';
else:
	return "error";
endif;
?>
